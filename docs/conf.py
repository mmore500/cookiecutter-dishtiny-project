...
# -*- coding: utf-8 -*-
#
# cut-dishtiny-project documentation build configuration file, created by
...
copyright = u"2025, Matthew Andres Moreno"
...
htmlhelp_basename = 'cut-dishtiny-projectdoc'
...
latex_documents = [
    (master_doc, 'cut-dishtiny-project.tex',
     u'Cut DISHTINY Project Documentation',
...
man_pages = [
    (master_doc, 'cut-dishtiny-project',
     u'Cut DISHTINY Project Documentation',
     [author], 1)
]
